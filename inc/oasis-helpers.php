...
function anna_get_oasis_default_content() {
	return array(
		...
		'inside_schedule_items' => array(
			...
			array( 'title' => 'Wednesday — Walk and Talk live at 1pm via Zoom.', 'body' => 'A weekly live session where we connect, share, go deeper and do the inner work together. This is the heartbeat of Oasis. Oasis Experience members only, with recordings available after.' ),
