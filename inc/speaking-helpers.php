...
function anna_get_speaking_default_content() {
	return array(
		...
		'hero_body'             => 'My talks draw on decades of elite sport, years of deep coaching work and my own profound personal journey — from the Olympics to rock bottom and back. Every talk is grounded in real life, backed by neuroscience and designed to leave your audience genuinely moved to act.',
		'hero_image_id'         => 0,
		'hero_button_text'      => 'Enquire About Speaking',
		'hero_button_url'       => '#contact',
		'hero_secondary_text'   => 'See speaking topics',
		'hero_secondary_url'    => '#speaking-topics',
		'hero_stat_items'       => array(
			array( 'value' => 'AUS', 'label' => 'Olympian and Commonwealth Games' ),
			array( 'value' => '7+', 'label' => 'Years coaching clients' ),
			array( 'value' => '102', 'label' => 'Five-star Google reviews' ),
			array( 'value' => '10+', 'label' => 'Professional qualifications' ),
			array( 'value' => 'IFS', 'label' => 'Trauma-informed and IFS trained' ),
		),

		'bring_eyebrow'         => 'What I bring to the stage',
		'bring_heading_line1'   => 'Real stories.',
		'bring_heading_line2'   => 'Real tools. Real impact.',
		'bring_body'            => "I have spent over a decade helping people understand why change feels so hard — and what actually creates it. That insight, combined with the credibility of an Olympic career and the authenticity of someone who has rebuilt their life from the ground up, makes for talks that land differently.\n\nI don't deliver polished performances. I have real conversations with audiences. And people leave feeling seen, understood and genuinely energised — not just inspired in the moment, but equipped with something they can actually use.",
		'bring_quote'           => 'My goal is always the same — to leave people feeling inspired, energised and equipped with practical tools they can apply in their own lives.',
		'bring_button_text'     => 'Enquire About Speaking',
		'bring_button_url'      => '#contact',
		'bring_image_id'        => 0,

		'topics_eyebrow'        => 'Speaking Topics',
		'topics_heading'        => 'Tailored to your audience. Grounded in lived experience.',
		'topics_intro'          => 'Every talk is tailored to the audience and the goals of the event. My sessions combine inspiring storytelling with practical insights that people can apply in their daily lives. Popular topics include:',
		'topics_card_items'     => array(
			array(
				'icon'  => 'brain',
				'title' => 'The Mind-Body Connection — Why What You Think Affects How You Feel',
				'body'  => 'An exploration of the relationship between the nervous system, the subconscious and behaviour. How our past programs our present and what we can do about it.',
			),
			array(
				'icon'  => 'target',
				'title' => 'Stress, the Vagus Nerve and Why Your Body Reacts the Way It Does',
				'body'  => 'The science of stress made practical and accessible. Why we respond the way we do and the tools that actually work to regulate the nervous system.',
			),
			array(
				'icon'  => 'heart',
				'title' => 'Goal Setting That Creates Lasting Change',
				'body'  => 'A fresh perspective on goal setting that goes beyond traditional ideas of success. Encouraging audiences to focus on self-awareness, values and meaningful change — not just achievement.',
			),
			array(
				'icon'  => 'leaf',
				'title' => 'Awareness, Acceptance, Action — A Framework for Lasting Change',
				'body'  => 'The three-step framework at the heart of my coaching work. Practical, powerful and immediately applicable to any area of life.',
			),
			array(
				'icon'  => 'compass',
				'title' => 'Values and Self-Leadership',
				'body'  => "Making decisions aligned with what actually matters — not what should matter. A practical exploration of values as an inner compass, and how self-leadership creates genuine confidence.",
			),
			array(
				'icon'  => 'shield',
				'title' => 'Building Resilience From the Inside Out',
				'body'  => 'What resilience actually is and how to build it. Not through toughening up, but through genuine self-understanding and nervous system regulation.',
			),
		),

		'formats_eyebrow'           => 'Talk Formats',
		'formats_heading'           => 'Three ways to work together.',
		'formats_card_items'        => array(
			array(
				'number' => '01',
				'title'  => 'Keynote presentations 30 to 60 minutes',
				'body'   => 'Inspiring presentations for conferences and events. 30 to 60 minutes. Combining personal storytelling, neuroscience-backed insights and practical tools audiences can apply straight away.',
			),
			array(
				'number' => '02',
				'title'  => 'Interactive workshops half day or full day',
				'body'   => 'Interactive half-day or full-day sessions focused on mindset, wellbeing and personal growth. Participants leave with a real experience of the work — not just ideas about it.',
			),
			array(
				'number' => '03',
				'title'  => 'Corporate wellness sessions',
				'body'   => 'Tailored sessions for teams and organisations. Creating space for connection, reflection and personal growth within a professional context. Also available as panel participation and MC work.',
			),
			array(
				'number' => '04',
				'title'  => "Women's or Men's gatherings and retreats",
				'body'   => 'Immersive sessions for intimate gatherings and retreats — tailored to the audience, the setting and the outcomes you want to create together.',
			),
			array(
				'number' => '05',
				'title'  => 'Panel discussions and Q and A',
				'body'   => 'Thoughtful panel participation and facilitated Q&A — bringing depth, warmth and practical insight to the conversation.',
			),
		),
		'formats_audience_heading'  => 'My talks are well suited to',
		'formats_audience_items'    => array(
			array( 'text' => "Women's events and conferences" ),
			array( 'text' => 'Community groups and fundraising events' ),
			array( 'text' => 'Schools and youth programs' ),
			array( 'text' => 'Health and wellness conferences' ),
			array( 'text' => 'Corporate wellbeing and leadership events' ),
			array( 'text' => 'Retreats and immersive experiences' ),
		),

		'takeaway_eyebrow'  => 'What audiences take away',
		'takeaway_heading'  => 'Not just inspired. Genuinely equipped.',
		'takeaway_body'     => "I don't just tell stories from a stage. I give audiences something real to take back into their lives — a framework, a question, a moment of genuine self-recognition that stays with them long after the event.\n\nAudiences leave my talks feeling seen, understood and ready to do something differently. That's the goal every single time.",
		'takeaway_items'    => array(
			array( 'text' => 'A renewed sense of motivation and genuine **possibility** — not just a temporary high' ),
			array( 'text' => 'Practical **tools** for navigating stress, challenge and change in real life' ),
			array( 'text' => 'Greater **self-awareness** and clarity about what has been getting in the way' ),
			array( 'text' => 'Inspiration to take **meaningful action** — grounded in understanding, not just motivation' ),
			array( 'text' => 'A framework they can come back to — **Awareness, Acceptance, Action**' ),
		),

		'experience_eyebrow'              => 'Recent Experience',
		'experience_heading_primary'      => 'InspireHER',
		'experience_heading_secondary'    => "Women's Conference",
		'experience_body'                 => "I recently had the honour of speaking at the InspireHER Women's Conference, sharing my personal journey of overcoming the fear of public speaking and finding my voice.\n\nIn this talk I explored a fresh perspective on goal setting and personal growth, encouraging women to look beyond traditional ideas of success and instead focus on self-awareness, values and meaningful change.\n\nEvents like InspireHER are incredibly powerful because they bring people together to share stories, inspire one another and reconnect with what truly matters.",
		...
		'experience_testimonial_quote'    => "I loved how Anna put a new spin on goal setting that I had never considered before. She was down to earth and knowledgeable. Having her present at InspireHER was very valuable for everyone present.",
		'experience_testimonial_name'     => 'Rachel Banner',
		'experience_testimonial_role'     => "Founder, InspireHER Women's Conference",
	);
}
...
function anna_get_speaking_page_content() {
	...
	$image_keys = array( 'hero_image_id', 'bring_image_id' );
	$textarea_keys = array( 'hero_body', 'bring_body', 'topics_intro', 'takeaway_body', 'experience_body' );
		...
		if ( is_array( $saved ) ) {
			...
			foreach ( $saved as $key => $value ) {
				if ( is_array( $value ) ) {
					...
					switch ( $key ) {
						case 'hero_stat_items':
							$normalized = anna_normalize_speaking_stat_items( $value );
							break;
						case 'topics_card_items':
							$normalized = anna_normalize_speaking_topic_cards( $value );
							break;
						case 'formats_card_items':
							$normalized = anna_normalize_speaking_format_cards( $value );
							break;
						case 'formats_audience_items':
						case 'takeaway_items':
							$normalized = anna_normalize_speaking_text_items( $value );
							break;
					}
					if ( ! empty( $normalized ) ) {
...
function anna_sanitize_speaking_option( $key, $value ) {
	...
	if ( in_array( $key, array( 'speaking_pg_formats_audience_items', 'speaking_pg_takeaway_items' ), true ) ) {
		return anna_normalize_speaking_text_items( $value );
	}
	if ( in_array( $key, array( 'speaking_pg_hero_image_id', 'speaking_pg_bring_image_id' ), true ) ) {
		return absint( $value );
	}
	$url_keys = array(
