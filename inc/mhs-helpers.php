...
function anna_sanitize_mhs_option( $key, $value ) {
	$image_keys = array( 'mhs_pg_hero_image_id', 'mhs_pg_opening_image_id', 'mhs_pg_inner_image_id' );
	if ( in_array( $key, $image_keys, true ) ) {
		return absint( $value );
	}
