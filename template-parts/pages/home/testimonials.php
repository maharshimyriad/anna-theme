...
<section class="anna-testimonials-section anna-section anna-section--lg" id="testimonials"
	...
	<div class="anna-container">
		<div class="anna-testimonials-section__header anna-reveal">
			<div>
				...
				<h2 class="anna-testimonials-section__heading" id="testimonials-heading">
					<span
						class="anna-testimonials-section__heading-main"><?php echo esc_html($heading_main); ?></span>
					<?php if ($heading_sub): ?>
		...
		<?php if ($section_data['cta_text']): ?>
			<div class="anna-testimonials-section__footer anna-reveal">
				<a href="<?php echo esc_url($section_data['cta_url']); ?>"
