			...
			<div class="anna-move-page-reviews__grid" role="list">
				<?php foreach ( $items as $review ) : ?>
					<figure class="anna-move-page-review-card" role="listitem">
						...
						<blockquote class="anna-move-page-review-card__quote"><p><?php echo esc_html( $review['quote'] ?? '' ); ?></p></blockquote>
						<figcaption class="anna-move-page-review-card__author">
							<cite class="anna-move-page-review-card__name"><?php echo esc_html( $review['name'] ?? '' ); ?></cite>
