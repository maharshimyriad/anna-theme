...
<main id="main-content" class="anna-main anna-single-main" role="main">
	<?php while (have_posts()):
		...
		<!-- ════════════════════════════════════════════════════════════════
		 ...
		 ════════════════════════════════════════════════════════════════ -->
		<section class="anna-hero-section anna-single-hero<?php echo $thumb_url ? ' anna-single-hero--has-image' : ''; ?>" <?php if ($thumb_url): ?>style="--hero-img: url('<?php echo esc_url($thumb_url); ?>');" <?php endif; ?>
