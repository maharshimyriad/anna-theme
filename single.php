...
<main id="main-content" class="anna-main anna-single-main" role="main">
	<?php while (have_posts()):
		...
		<!-- ════════════════════════════════════════════════════════════════
		 ...
		 ════════════════════════════════════════════════════════════════ -->
		<header class="anna-single-hero<?php echo $thumb_url ? ' anna-single-hero--has-image' : ''; ?>" <?php if ($thumb_url): ?>style="--hero-img: url('<?php echo esc_url($thumb_url); ?>');" <?php endif; ?>
		...
		<nav class="anna-single-nav" id="anna-post-nav"
			aria-label="<?php esc_attr_e('Post navigation', 'anna-baylis'); ?>">
			<div class="anna-container anna-container--max">
				<?php
				the_post_navigation(
					array(
							...
							<article class="anna-blog-card">
								...
								<div class="anna-blog-card__body">
									...
									<footer class="anna-blog-card__footer">
										<time class="anna-blog-card__date"
